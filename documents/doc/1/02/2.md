[[:markdown: 02-1 함수란?](#/doc/1/02/1)] 페이지에서 함수를 적용하고 `Hello, Datapack!`까지 출력했습니다.
...
```
   ...
   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/02-2/load_json.mp4" type="video/mp4">
   </video>

이제 인게임에서 `/reload`를 입력하면 자동으로 함수가 실행됩니다.

   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/02-2/reload.mp4" type="video/mp4">
   </video>
...
<video width="640" height="360" controls>
      <source src="/Wiqi/vid/02-2/tick_json.mp4" type="video/mp4">
   </video> 

이제 인게임에서 `/reload`를 입력하면 `0.05`초마다 함수가 실행됩니다.

   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/02-2/tick.mp4" type="video/mp4">
   </video> 