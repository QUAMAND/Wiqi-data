- [[:markdown: 02-4 재귀함수](#/doc/1/02/4)] 글을 읽고 오는 것을 추천드립니다.
...
[[:markdown: 02-4 재귀함수](#/doc/1/02/4)] 페이지 하단에 `y0.0`에서 `y1.0`까지 `dust` 입자를 표시하는 예시 구문을 확인할 수 있는데,
...
```
   ...
   <video width="640" height="360" controls>
     <source src="/Wiqi/vid/02-4-1/raycast.mp4" type="video/mp4">
   </video>
...
```
   ...
   <video width="640" height="360" controls>
     <source src="/Wiqi/vid/02-4-1/raycast_way.mp4" type="video/mp4">
   </video>
...
`execute` 명령어 인수 중, `as`/`facing`/`rotated` 등과 같은 [[:markdown: 01-1 컨텍스트](#/doc/2/01/1)]는 `n` 개의 엔티티만큼 실행합니다.
...
![rotated](/Wiqi/img/docs/rotated.png)
...
```
![rotated1](/Wiqi/img/docs/rotated_0125.png)

단점으로는 앞의 블록을 뚫어 버립니다.  
![rotated2](/Wiqi/img/docs/rotated_block.png)
