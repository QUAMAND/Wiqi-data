`pack.mcmeta`는 [[:minecraft: <span style="font-family: 'minecraft';"/> Minecraft 1.21.9](https://minecraft.wiki/w/Java_Edition_1.21.9)] 업데이트를 거치면서 형식이 바뀌는 중입니다.  
현재 이 문서는 [[:minecraft: <span style="font-family: 'minecraft';"/> Minecraft 1.21.8](https://minecraft.wiki/w/Java_Edition_1.21.8)] 버전의 마인크래프트까지만 적용됩니다.
...
이를 이용하면 하나의 데이터 팩으로 [[:minecraft: <span style="font-family: 'minecraft';"/> Minecraft 1.21.1](https://minecraft.wiki/w/Java_Edition_1.21.1)] ~ [[:minecraft: <span style="font-family: 'minecraft';"/> Minecraft 1.21.8](https://minecraft.wiki/w/Java_Edition_1.21.8)] 버전에서 동작할 수 있는 데이터 팩을 제작할 수 있습니다.
