...
[[:minecraft: <span style="font-family: 'minecraft';"/> Minecraft 1.21.6](https://minecraft.wiki/w/Java_Edition_1.21.6)] 이상이라면, `/datapack create` 명령어로 기본 데이터 팩을 생성할 수 있습니다.
...
현재 세계를 저장하고 나간 뒤, 편집을 클릭하면 세계 폴더 열기라는 항목이 표시됩니다.
   ...
   ![map_folder.png](/Wiqi/img/docs/map_folder.png)
...
새 데이터 팩을 생성하기 위해서는 폴더가 하나 필요합니다.
   ...
   <video width="640" height="360" controls>
     <source src="/Wiqi/vid/01-3/new_folder.mp4" type="video/mp4">
   </video>

조금 더 나은 폴더/파일 생성 및 제거를 위해 Visual Studio Code로 불러오도록 하겠습니다.

   <video width="640" height="360" controls>
     <source src="/Wiqi/vid/01-3/folder_to_visual.mp4" type="video/mp4">
   </video>
...
- `pack.mcmeta`에 대한 자세한 내용은 [[:markdown: 01-3-1 pack.mcmeta](#/doc/1/01/3/1)] 페이지에서 확인할 수 있습니다.
...
새 `pack.mcmeta` 파일을 만들 수 있지만, 조금 더 쉽게 제작할 수 있는 도구가 있습니다.
   ...
   <video width="640" height="360" controls>
     <source src="/Wiqi/vid/01-3/pack_mcmeta.mp4" type="video/mp4">
   </video>
   ...
   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/01-3/visual_setting.mp4" type="video/mp4">
   </video>   
...
이번에는 `test2` 폴더 만 가지고 오는 것과 달리 `datapacks` 폴더 전체를 불러옵니다.
   ...
   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/01-3/datapacks_move.mp4" type="video/mp4">
   </video>   

그리고 데이터 팩을 생성합니다.

   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/01-3/extensions.mp4" type="video/mp4">
   </video>   