...
[[:markdown: 02-1 함수란?](#/doc/1/02/1)] 페이지에서 만들었던 함수처럼, `predicate` 폴더를 만듭니다.

   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/03-1/predicate_folder.mp4" type="video/mp4">
   </video>
...
`Root` 밑에 있는 `Condition` 목록을 클릭해 사용 가능한 조건을 확인할 수 있습니다.
   ...
   <video width="640" height="360" controls>
      <source src="/Wiqi/vid/03-1/predicate_conditions.mp4" type="video/mp4">
   </video>
...
참고로 [[:minecraft: <span style="font-family:minecraft"/> Minecraft 1.20.5](https://www.minecraft.net/en-us/article/minecraft-java-edition-1-20-5)] 이후 버전부터는  
...
- [[all_of]](#/doc/1/03/2)
- [[any_of]](#/doc/1/03/3)
- [[entity_properties]](#/doc/1/03/4)
- [[inverted]](#/doc/1/03/5)
- [[location_check]](#/doc/1/03/6)
- [[weather_check]](#/doc/1/03/7)