...
[[:snapshot: <span style="font-family:minecraft"/> Minecraft 18w01a](https://www.minecraft.net/en-us/article/minecraft-snapshot-18w01a)] 버전 이후로 모장은 내부 데이터 및 데이터 생성기를 공개했습니다.
...
예를 들어, [[:minecraft: <span style="font-family:minecraft"/> Minecraft 1.21.8](https://minecraft.wiki/w/Java_Edition_1.21.8)]은 다음과 같이 구성되어 있습니다.
```json
{
   "id": "1.21.8",
   "type": "release",
...
예를 들어, [[:minecraft: <span style="font-family:minecraft"/> Minecraft 1.21.8](https://minecraft.wiki/w/Java_Edition_1.21.8)] 버전은 다음과 같이 구성되어 있습니다.
```json
"server": {
