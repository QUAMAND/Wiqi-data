`/jfr` 명령어는 [[:snapshot: <span style="font-family: code"/> Minecraft 21w37a (1.18 스냅샷)](https://www.minecraft.net/en-us/article/minecraft-snapshot-21w37a)]에 추가되었으며, [[Java Flight Recorder](https://openjdk.org/jeps/328)]를 이용해 측정합니다.
...
[[:snapshot: <span style="font-family: code"/> Minecraft 25w45a](https://minecraft.wiki/w/Java_Edition_25w45a)] 버전 이후부터는 별도의 난독화가 이루어지지 않은 버전이 출시될 예정입니다. (`<version> Unobfuscated`)
