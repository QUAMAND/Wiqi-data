...
선택자에 대한 내용은 [[:markdown: 01-3 선택자](#/doc/2/01/3)]을 참고하십시오.
...
- [[:minecraft: <span style="font-family:minecraft"/> Minecraft 1.19.3](https://www.minecraft.net/en-us/article/minecraft-java-edition-1-19-3)] 버전에서 추가되었습니다.
...
자세한 내용은 [[:markdown: 04-2 엔티티](#/doc/2/04/2)] 페이지를 참고하십시오.
